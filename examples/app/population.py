...
from bokeh.models import ColumnDataSource, CustomJSTransform, JSTickFormatter, Select
...
pyramid.xaxis.formatter = JSTickFormatter(code="""
...
population.yaxis.formatter = JSTickFormatter(code="""
