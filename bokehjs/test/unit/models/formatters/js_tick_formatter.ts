...
import {JSTickFormatter} from "@bokehjs/models/formatters/js_tick_formatter"
import {Range1d} from "@bokehjs/models/ranges/range1d"

describe("JSTickFormatter", () => {

  describe("_make_func method", () => {
    const formatter = new JSTickFormatter({code: "return 10"})
  ...
  describe("doFormat method", () => {
    it("should format numerical ticks appropriately", () => {
      const formatter = new JSTickFormatter({code: "return tick.toFixed(2)"})
    ...
    it("should format categorical ticks appropriately", () => {
      const formatter = new JSTickFormatter({code: "return tick + '_lat'"})
    ...
    */
    ...
    it("should handle args appropriately", () => {
      ...
      const formatter = new JSTickFormatter({
